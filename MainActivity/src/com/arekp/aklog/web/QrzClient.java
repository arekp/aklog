...
public class QrzClient extends AsyncTask<String, Void, Void> {
	...
	protected void onPreExecute() {
		// TODO Auto-generated method stub
		Log.d(DEBUG_TAG, "jestesmy w onPreExecute ");
		 dialog = new Dialog(context);
			dialog.setContentView(R.layout.dialog_info);
			Log.d(DEBUG_TAG,"wczytano dialog" );
		dialog.setTitle("Logujemy sie !!");
		dialog.show();
		super.onPreExecute();
	}
	...
	public QrzSession getkey(String user, String passwd)
		...
		try {
			...
			String url = "http://xmldata.qrz.com/xml/current/?username=" + user
					+ ";password=" + passwd;
			try {
				...
				while (eventType != XmlPullParser.END_DOCUMENT) {
					...
					case XmlPullParser.START_TAG:
						if (tagname.equalsIgnoreCase("Session")) {
							...
							Log.d(DEBUG_TAG, "START_TAG: Session " + text+ "KONIEC SESSION");
						}
						break;
	...
	protected Void doInBackground(String... params) {
		...
		try {
			Log.d(DEBUG_TAG,"Przed sprawdzeniem klucza" );
			sess =getkey(params[0],params[1]);
